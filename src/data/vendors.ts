...
export const vendors: Vendor[] = [
  ...
  { name: "Jai", tasks: "Aft cabin sofa-bed build / carpentry", contact: "Jai", phone: "+31 6 83 95 82 58", email: "", notes: "https://www.jaivw.com/ — Did the aft cabin sofa-bed job instead of Simone in the end. Great job done. ✅ COMPLETED" },
  { name: "Réifier (Simone)", tasks: "Window frame repair, furniture maker", contact: "Simone", phone: "+31 6 15897070", email: "contact@reifier.nl", notes: "Furniture maker. https://reifier.nl/ — Did boat window fix (azobe + iroko beams, sealant, 10hrs labour = €476.78) + follow-up labour (€101.64). Total: €578.42. KvK 96832606. BTW NL005235697B42. IBAN NL85ASNB8851750637. Sofa-bed was ultimately done by Jai, not Simone." },
  { name: "Multiship Holland", tasks: "Booked August 2026 for Timo full works", contact: "Multiship Holland", phone: "", email: "", notes: "Timo is booked with Multiship Holland in August 2026 for the whole works." },
