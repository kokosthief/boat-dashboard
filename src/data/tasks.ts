...
export const tasks: Task[] = [
  ...
  { name: "Sand blast boat", location: "Outside Hull", vendor: "Multiship Holland", status: "Planning", targetDate: "2026-08-01", cost: "€1,000", notes: "Timo booked with Multiship Holland in August 2026 for the whole works. Fully sand blast whole boat to bare metal." },
  { name: "Paint Exterior", location: "Outside Hull", vendor: "Multiship Holland", status: "Planning", targetDate: "2026-08-01", cost: "", notes: "Timo booked with Multiship Holland in August 2026 for the whole works. Hull and exterior black." },
  { name: "Antifouling", location: "Outside Hull", vendor: "Multiship Holland", status: "Planning", targetDate: "2026-08-01", cost: "", notes: "Timo booked with Multiship Holland in August 2026 for the whole works. Apply antifouling coats." },
  ...
  { name: "Aft cabin sofa-bed build", location: "Salon", vendor: "Jai", status: "Finished", targetDate: "2026-06-30", cost: "€1,700", notes: "Jai did the sofa-bed job instead of Simone in the end. Sofa converts to double bed in aft cabin. Great job done." },
